    ...
    <section className="relative w-full py-12 flex justify-center items-center">
      <div className="relative w-[90%] max-w-6xl bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 rounded-2xl shadow-xl py-20 px-10 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <Button className="relative mt-10 px-8 py-3 bg-white text-black font-semibold rounded-full shadow-md transition-all duration-300 hover:scale-105 before:absolute before:inset-0 before:bg-gradient-to-r before:from-gray-300 before:to-gray-500 before:blur-lg before:opacity-50">
            Get Started
          </Button>
        </div>
      </div>
